          ...
          <div class="col">
            <div class="contact-form form-style-3">
                ...
                <div class="row">
                  <div class="form-group col">
                    ...
                    <input type="text" data-msg-required="Please enter the subject." maxlength="100"
                      class="form-control text-3 h-auto py-2" name="id" v-model="entrprsId" placeholder="아이디를 입력해주세요"
                      autoComplete="off" @focus="handleFocus" @blur="handleBlur" />
                ...
                <div class="row">
                  <div class="form-group col">
                    ...
                    <input type="password" value="" data-msg-required="Please enter the subject." maxlength="100"
                      class="form-control text-3 h-auto py-2" placeholder="비밀번호를 입력해주세요" autoComplete="off"
                      v-model="entrprsPswrd" @focus="handleFocus" @blur="handleBlur" />
                  </div>
                </div>
              ...
              <ul class="d-flex justify-content-between nav nav-pills" id="mainNav">
                ...
                <li>
                  <router-link to="/enter/find" class="dropdown-item">아이디, 비밀번호 찾기</router-link>
                </li>
              </ul>
              <hr />
              <div class="align-self-center">
                <ul class="d-flex justify-content-center nav nav-pills" id="mainNav">
                  <li class="dropdown">
                    <a href="#" @click="naverLogin" class="dropdown-item"><img
                        :src="require('@/assets/naverlogo/btnG_아이콘원형.png')" class="socialLogo" /></a>
                  </li>
                </ul>
              </div>
            </div>
...
const redirect_uri = `${baseUrl}/member/loginNCallback`;
