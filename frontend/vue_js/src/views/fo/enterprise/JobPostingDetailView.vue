        ...
        <div class="row mt-3">
          ...
          <div class="col-md-3">
            <div class="mb-3">
              ...
              <input type="text" v-model="jbp.enterpriseName" class="form-control" id="enterpriseName"
                placeholder="기업 이름" readonly />
            </div>
          </div>
          <div class="col-md-2">
            <div class="mb-3">
        ...
        <div class="row mt-3">
          ...
          <div class="col-md-4">
            <div class="mb-3">
              ...
              <input type="text" v-model="jbp.workArea" class="form-control" id="workArea" placeholder="근무지역"
                readonly />
            </div>
          </div>
        </div>
        ...
        <div class="row mt-3">
          <div class="col-md-4">
            <div class="mb-3">
              ...
              <input type="text" v-model="jbp.workForm" class="form-control" id="workForm" placeholder="근무형태"
                readonly />
            </div>
          </div>
          <div class="col-md-4">
