...
//	월별 지원 공고 데이터 AC
	public List<Map<String, Object>> getToMakeCalendarData(@Param("mbr_sq")Long mbr_sq,@Param("rsm_sq") Long rsm_sq,@Param("month") int month);
	
	
//	포지션 제안 수락 여부 Check
	public String getPstnPrpslAcceptYN(Long mbr_sq);

// 	포지션 제안 수락 여부 변경
	public int updatePstnPrpslAcceptYN(@Param("mbr_sq") Long mbr_sq, @Param("pstn_prpsl_accept_yn") String pstn_prpsl_accept_yn);
