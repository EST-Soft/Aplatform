                  ...
                  <router-link :to="`/board/detail/jobPosting/${item.jbpSq}`" class="routerLink"
                    ...
                    <div class="profile-image-container" v-if="hoveredItem !== idx">
                      <div class="profile-image">
                        ...
                        <img v-if="item.enterpriseMember.logoFileUrl" :src="item.enterpriseMember.logoFileUrl"
                          alt="Company Logo" />
                    ...
                    <div v-if="hoveredItem !== idx" style="font-size: 16px">{{ item.enterpriseMember.entrprsName }}
                    </div>
                    <div v-if="hoveredItem !== idx" style="font-size: 14px">
                      {{ formatWorkArea(item.workArea) }}&nbsp;/&nbsp;{{ getCareerText(item.crrDrtn) }}&nbsp;/&nbsp;{{
                        getEducationText(item.edctn) }}&nbsp;/&nbsp;{{ formatJobName(item.jobName) }}
                    </div>
                  </router-link>
                </div>
              </div>
