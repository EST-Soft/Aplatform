      ...
      <aside className="sidebar">
        ...
        <ul className="nav nav-list flex-column mb-5">
          <li className="nav-item">
            <Link className="nav-link" to="/mypage/home">
              현황 및 일정
            </Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link">이력서 관리</Link>
            <ul>
              <li className="nav-item">
                <Link className="nav-link" to="/mypage/resume-form">
                  이력서 등록
                </Link>
              </li>
              <li className="nav-item">
                <Link className="nav-link" to="/mypage/resume-list">
                  이력서 목록
                </Link>
              </li>
            </ul>
          ...
          <li className="nav-item">
            <Link className="nav-link" to="/mypage/applycompanylist">
              입사지원현황
            </Link>
          </li>
          <li className="nav-item">
            <Link className="nav-link" to="/mypage/jobViewList">
              최근 본 공고
            </Link>
          </li>
